...
const templateOne = (_data = sampleDataOne.type) => {
  return (
    "Нашакомпания ,в лице директора ФИОдиректора Нашей Компании действующего на основании Устава, с одной стороны, именуемое в дальнейшем 'Поставщик' и " +
    _data.compFullName +
    " , в лице генерального директора  ФИО второй стороны , действующего(ей) на основании Устава, именуемое в дальнейшем 'Покупатель',РЕКВИЗИТЫ СТОРОН: " +
    " Покупатель: " +
    _data.compShortName +
    " ИНН: " +
    _data.INN +
...
const templateTwo = (_data = sampleDataTwo.type) => {
  return (
    "Наша компания, в лице директора ФИОдиректора нашей компании, действующего на основании Устава, с одной стороны, именуемое в дальнейшем 'Поставщик' и " +
    _data.Name +
    " , в лице генерального директора " +
    _data.FIO +
    ", действующего(ей) на основании Устава, именуемое в дальнейшем 'Покупатель', РЕКВИЗИТЫ СТОРОН: Покупатель: " +
    _data.Name +
    " ИНН: " +
    _data.INN +
    " ОГРНИП: " +
...
const templateThree = (_data = sampleDataTwo.type) => {
  return (
    ...
    " код подразделения " +
    _data.codeGave +
    " , именуемый(ая) в дальнейшем 'Покупатель', РЕКВИЗИТЫ СТОРОН: Покупатель: " +
    _data.lastName +
    " " +
    _data.firstName +
    " " +
  ...
  <Document>
    <Page style={styles.page}>
      <View style={styles.section}>
        <Text style={styles.content}>{_props.text}</Text>
      </View>
    </Page>
  </Document>
);
...
const BeautyText = _props => (
  <div>
    ...
    <PDFDownloadLink
      document={<PdfDocument text={data_to_text(_props.text, _props.store)} />}
      fileName="somename.pdf"
    >
      {({ blob, url, loading, error }) =>
        loading ? "Loading document..." : "Забери PDF если считаешь что он ок."
      }
    </PDFDownloadLink>
  </div>
);
